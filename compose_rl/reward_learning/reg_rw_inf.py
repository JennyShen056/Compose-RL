...
def download_s3_model(s3_uri: str, local_dir: str):
    ...
    logger.info(f"Downloading model files from bucket '{bucket_name}' with prefix '{prefix}' to {local_dir}")
        ...
        for text in batch_texts:
            try:
                ...
                if hasattr(tokenizer, "apply_chat_template"):
                    ...
                    formatted_text = " ".join([msg.get("content", "") for msg in conversation])
